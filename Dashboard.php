                            ...
                            <div class="modal-body custom-modal-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input list="browsersloadtype" placeholder="--Select--" class="form-control"
                                               id="loadtypelist" name="loadtypelist">
                                        ...
                                        <datalist id="browsersequipment">
                                            ...
                                            foreach ($show_equipment as $showequipment) {
                                                ...
                                                foreach ($equipment as $se) {
                                                    $equ = $se["equipmentType"];
                                                    $e = "'$equ'";
                                                    ?>
                                                    <option value="<?php echo $se['_id'] . ") " . $e; ?>">
                                                <?php }
                                            } ?>
                                        </datalist>
                                    </div>
                                ...
                                <div class="row col-md-12">
                                    ...
                                    <div class="form-group col-md-2 carrier">
                                        ...
                                        <input list="browserscarrier" class="form-control" placeholder="--Select--"
                                               id="carrierlist" name="carrierlist">
                                    ...
                                    <div class="form-group col-md-2 carrier">
                                        <label>Charges</label><i class="mdi mdi-plus-circle plus"
                                ...
                                <div class="ui small form segment">
                                    <h6>
                                        <button class="btn btn-primary" onclick="add_fields();">ADD SHIPPER</button>
