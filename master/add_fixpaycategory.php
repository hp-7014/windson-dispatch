            ...
            <div class="modal-body custom-modal-body" style="padding: 0.1rem">
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <a class="btn btn-outline-success waves-effect waves-light float-right"
                        href="download_csv_file.php?file=Fix_Pay_Category.csv" style="margin-bottom: 2px;">CSV formate
                    </a>
                </form>
                                ...
                                <tbody id="fixpayBody">
                                    ...
                                    <tr>
                                        ...
                                        <td class="custom-text" id="<?php echo "fixPayType".$i; ?>"
                                            ...
                                            <i id="<?php echo "fixPayPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $fixPayType; ?>,'updatefixPay','text',<?php echo $row1['_id']; ?>,'fixPayType','Fix Pay Type',<?php echo $pencilid; ?>)"></i>
                                            <?php echo $row1['fixPayType']; ?>
                                        </td>
                                        <td><a href="#" onclick="deletefixpay(<?php echo $id; ?>)"><i
