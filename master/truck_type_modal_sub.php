...
<div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
    id="Add_Truck_Type" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            <input class="form-control" placeholder="Name *" type="text" id="truck_add_type">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger waves-effect modalTruckType">Close
                    </button>
