                    ...
                    <div class="table-responsive b-0" data-pattern="priority-columns">
                        ...
                        <div id="table-scroll" class="table-scroll">
                            <table id="company_table" class="scroll">
                                <thead>
                                    <tr>
                                        <th scope="col" col width="60">No</th>
                                        <th scope="col" col width="160" data-priority="1">Company Name</th>
                                        <th scope="col" col width="160" data-priority="3">Shipping Address</th>
                                        <th scope="col" col width="160" data-priority="1">Telephone No</th>
                                        <th scope="col" col width="160" data-priority="3">Fax No</th>
                                        <th scope="col" col width="160" data-priority="3">M.C. No.</th>
                                        <th scope="col" col width="160" data-priority="6">US DOT No.</th>
                                        <th scope="col" col width="160" data-priority="6">Mailing Address</th>
                                        <th scope="col" col width="160" data-priority="6">Factoring Company</th>
                                        <!-- <th scope="col" col width="160" data-priority="1"><marquee width="140px" direction="left" height="17px" scrollamount="1">Factoring Company Address</marquee></th> -->
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td class="custom-text" id="<?php echo "companyName".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "companynmPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $companyName; ?>,'updateCompany','text',<?php echo $s['_id']; ?>,'companyName','Company Name',<?php echo $pencilid1; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "shippingAddress".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "shippingAddressPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $shippingAddress; ?>,'updateCompany','text',<?php echo $s['_id']; ?>,'shippingAddress','shipping Address',<?php echo $pencilid2; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "telephoneNo".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "telephoneNoPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $telephoneNo; ?>,'updateCompany','text',<?php echo $s['_id']; ?>,'telephoneNo','Telephone No.',<?php echo $pencilid3; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "faxNo".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "faxNoPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $faxNo; ?>,'updateCompany','text',<?php echo $s['_id']; ?>,'faxNo','Fax No.',<?php echo $pencilid4; ?>)"
                                                    ></i>
                                                    <?php echo $s['faxNo']; ?>
                                                </td>
                                                <td class="custom-text" id="<?php echo "mcNo".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "mcNoPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $mcNo; ?>,'updateCompany','text',<?php echo $s['_id']; ?>,'mcNo','MC No.',<?php echo $pencilid5; ?>)"
                                                    ></i>
                                                    <?php echo $s['mcNo']; ?>
                                                </td>
                                                <td class="custom-text" id="<?php echo "usDotNo".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "usDotNoPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $usDotNo; ?>,'updateCompany','text',<?php echo $s['_id']; ?>,'usDotNo','US DOT No.',<?php echo $pencilid6; ?>)"
                                                    ></i>
                                                    <?php echo $s['usDotNo']; ?>
                                                </td>
                                                <td class="custom-text" id="<?php echo "mailingAddress".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "mailingAddressPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $mailingAddress; ?>,'updateCompany','text',<?php echo $s['_id']; ?>,'mailingAddress','Mailing Address.',<?php echo $pencilid7; ?>)"
                                                    ></i>
                                                ...
                                                <td>
                                                    <?php if($counter == 0) { ?>
                                                        <a href="#" onclick="deleteCompany(<?php echo $s['_id']; ?>,<?php echo $factoringid; ?>)"><i class="mdi mdi-delete-sweep-outline" style="font-size: 20px; color: #FC3B3B"></i></a>
                                                    <?php } else { ?>
