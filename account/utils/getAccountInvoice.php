    ...
    foreach ($show1 as $arrData) {
        ...
        foreach ($arrData1 as $row1) {
            ...
            $table .= '<tr>
                ...
                <td>' . $driverName1 . '</td>
                <td>
                    <select class="form-control" onchange="changeStatus(' . $activeLoadId1 . ','.$statusOld.',this.value)" id="loadStatus1"
                            style="width: 170px">
    ...
    foreach ($show1 as $row) {
        ...
        foreach ($trailer as $row4) {
            ...
            if ($_POST['getoption'] == $row4['_id']
                ...
                <td>' . $driverName1 . '</td>
                <td>
                    <select class="form-control" onchange="changeStatus(' . $invoiceID1 . ','.$statusOld.',this.value)" id="loadStatus1" style="width: 170px">
                        <option value="0">--Select--</option>';
