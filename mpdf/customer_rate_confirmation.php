...
$data = $header = '<table width="100%">
    <tr>
        ...
        <td width="49%"><h2 style="font-size:14px">KELSEY KITTRIDGE</h2><p style="font-size:12px">Phone: 701-353-5939</p>
        <p style="font-size:12px">Email: kelsey@armstrongtransport.com</p></td>
        
        <td width="31%" style="text-align: left;"><h2 style="font-size:14px;">Customer Rate Confirmation</h2><span></span>
...
$data .= '<div class="row" style="margin-top:20px;border:none;background-color:white">
                    ...
                    <thead>
                      ...
                      <tr>
                        <td width="60%" style="text-align: left;background-color:#02c58d;color:white;padding:5px;"><h3 style="font-size:11px;">Shipper 1</h3></td>
...
$data .= '<div class="row" style="margin-top:20px;border:none;background-color:white">
                    ...
                    <thead>
                      <tr>
                        <td width="60%" style="text-align: left;background-color:#fc5454;color:white;padding:5px;"><h3 style="font-size:11px;">Consignee 1</h3></td>
...
$data .= '
    ...
    <tr>
        ...
        <td width="25%" style="line-height:2.5; padding:5px; ">
        <h3>LTL:<span style="font-weight:normal"> $300.00</span></h3>
...
$data .= '
    ...
    <tr>
        <td width="100%" style="line-height:2.5; padding:5px;">
        <h3>Please sign and fax back at your earliest convenience to the attention of the dispather noted above.
