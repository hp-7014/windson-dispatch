                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div>
                                ...
                                <span toggle="#driverPasswordEdit" class="fa fa-fw fa-eye pasword-icon-btn toggle-password"></span>
                            </div>
                        </div>
                        <div class="form-group col-md-2 ">
                        ...
                        <div class="form-group col-md-2 ">
                            ...
                            <div>
                                <button id="recurrenceplus" class="btn btn-outline-dark waves-effect waves-light">
                                    Open
                                    recurrence +
                                </button>
                            </div>
                        ...
                        <div class="form-group col-md-2 ">
                            <label>Recurrence -</label>
                            <div>
                                <button id="recurrenceminus" class="btn btn-outline-dark waves-effect waves-light">
                                    Open
                                    recurrence -
                                </button>
                            </div>
