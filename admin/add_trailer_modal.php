        ...
        <div class="modal-content custom-modal-content">
            ...
            <div class="modal-body custom-modal-body" style="padding: 0.1rem">
                ...
                <input class="form-control col-md-2 col-sm-4 col-lg-2 float-right" type="text" id="search"
                    onkeyup="search_trailer(this)" placeholder="search" style="margin-left: 5px;">
                <button class="btn btn-primary float-left" type="button" data-toggle="modal" data-target="#"
                    id="AddTrailer"><i class="mdi mdi-gamepad-down"></i>&nbsp;ADD</button>
                            ...
                            <table id="trailer_table" class="scroll">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" col width="160" data-priority="1">Model</th>
                                        ...
                                        <th scope="col" col width="160" data-priority="1">Activation Date</th>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="custom-text" id="<?php echo "licenseType".$i; ?>"
                                            ...
                                            <i id="<?php echo "licenseTypePencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $licenseType; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'licenseType','License Plate',<?php echo $pencilid2; ?>)"></i>
                                        ...
                                        <td class="custom-text" id="<?php echo "plateExpiry".$i; ?>"
                                            ...
                                            <i id="<?php echo "plateExpiryPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $plateExpiry; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'plateExpiry','Plate Expiry',<?php echo $pencilid3; ?>)"></i>
                                        ...
                                        <td class="custom-text" id="<?php echo "inspectionExpiration".$i; ?>"
                                            ...
                                            <i id="<?php echo "inspectionExpirationPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $inspectionExpiration; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'inspectionExpiration','Inspection Expiration',<?php echo $pencilid4; ?>)"></i>
                                        ...
                                        <td class="custom-text" id="<?php echo "status".$i; ?>"
                                            ...
                                            <i id="<?php echo "statusPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $status_r; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'status','Status',<?php echo $pencilid5; ?>)"></i>
                                        ...
                                        <td class="custom-text" id="<?php echo "model".$i; ?>"
                                            ...
                                            <i id="<?php echo "modelPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $model; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'model','Status',<?php echo $pencilid6; ?>)"></i>
                                            <?php echo $row1['model']; ?>
                                        </td>
                                        <td class="custom-text" id="<?php echo "year".$i; ?>"
                                            ...
                                            <i id="<?php echo "yearPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $year; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'year','Year',<?php echo $pencilid7; ?>)"></i>
                                            <?php echo $row1['year']; ?>
                                        </td>
                                        <td class="custom-text" id="<?php echo "axies".$i; ?>"
                                            ...
                                            <i id="<?php echo "axiesPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $axies; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'axies','Axios',<?php echo $pencilid8; ?>)"></i>
                                            <?php echo $row1['axies']; ?>
                                        </td>
                                        <td class="custom-text" id="<?php echo "registeredState".$i; ?>"
                                            ...
                                            <i id="<?php echo "registeredStatePencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $registeredState; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'registeredState','Registered State',<?php echo $pencilid9; ?>)"></i>
                                        ...
                                        <td class="custom-text" id="<?php echo "vin".$i; ?>"
                                            ...
                                            <i id="<?php echo "vinPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $vin; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'vin','VIN',<?php echo $pencilid10; ?>)"></i>
                                            <?php echo $row1['vin']; ?>
                                        </td>
                                        <td class="custom-text" id="<?php echo "dot".$i; ?>"
                                            ...
                                            <i id="<?php echo "dotPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $dot; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'dot','Dot Expiry Date',<?php echo $pencilid11; ?>)"></i>
                                            <?php echo $dot; ?>
                                        </td>
                                        <td class="custom-text" id="<?php echo "activationDate".$i; ?>"
                                            ...
                                            <i id="<?php echo "activationDatePencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $activationDate; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'activationDate','Activation Date',<?php echo $pencilid12; ?>)"></i>
                                        ...
                                        <td class="custom-text" id="<?php echo "internalNotes".$i; ?>"
                                            ...
                                            <i id="<?php echo "internalNotesPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $internalNotes; ?>,'updateTrailerAdd','text',<?php echo $row1['_id']; ?>,'internalNotes','Internal Notes',<?php echo $pencilid13; ?>)"></i>
                                            <?php echo $row1['internalNotes']; ?>
                                        </td>
                                        <td>
                                            <?php if ($counter == 0) { ?>
                                            <a href="#"
                                                onclick="deleteTrailerAdd(<?php echo $id; ?>,<?php echo $trailerT; ?>)"><i
            ...
            <div class="modal-footer1">
                <button type="button" onclick="exportTrailerAdd()"
                    ...
                    <ul class="pagination" id="paginate">
                        <li id="bank_previous" style="display:none">
                            <a class="page-link btn btn-secondary waves-effect"
                                onclick="previous_page('paginate_trailer','page_no',<?php echo $limit ?>,<?php echo $total_pages ?>)">Previous</a>
                        </li>
                        <select class="form-control" id="page_active"
                            onchange="paginate_trailer(this.value * <?php echo $limit; ?>,<?php echo $limit ?>,<?php echo $total_pages; ?>)">
                            <?php
                        $j = 1;
                        ...
                        <li id="bank_next">
                            <a class="page-link btn btn-primary waves-effect waves-light"
                                onclick="next_page('paginate_trailer','page_no',<?php echo $limit ?>,<?php echo $total_pages ?>)">Next</a>
                        </li>
                        <?php } ?>
                    </ul>
                </nav>
