                                    ...
                                    foreach ($c_broker as $custom) {
                                        ...
                                        if ($custom['delete_status'] == '0') {
                                            ...
                                            <tr>
                                                <th><?php echo $i++ ?></th>
                                                <td>
                                                    <a href="#" id="brokerName<?php echo $custom['_id']; ?>1"
                                                       data-type="textarea"
                                                       onclick="showTextarea(this.id,'text',<?php echo $custom['_id']; ?>,'brokerName');"
                                                       class="text-overflow"><?php echo $custom['brokerName']; ?></a>
                                                    <button type="button" id="brokerName<?php echo $custom['_id']; ?>"
                                                            onclick="updateCustom('brokerName',<?php echo $custom['_id']; ?>)"
                                                ...
                                                <td>
                                                    <a href="#" id="crossing<?php echo $custom['_id']; ?>1"
                                                       data-type="textarea"
                                                ...
                                                <td>
                                                    <a href="#" id="ext<?php echo $custom['_id']; ?>1"
                                                       data-type="textarea"
                                                ...
                                                <td>
                                                    <a href="#" id="tollfree<?php echo $custom['_id']; ?>1"
                                                       data-type="textarea"
                                                ...
                                                <td>
                                                    <a href="#" id="fax<?php echo $custom['_id']; ?>1"
                                                       data-type="textarea"
                                                ...
                                                <td>
                                                    <a href="#" id="Status<?php echo $custom['_id']; ?>1"
                                                       data-type="textarea"
