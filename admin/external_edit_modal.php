...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="edit_External"
        ...
        <div class="modal-content custom-modal-content">
            ...
            <div class="modal-body custom-modal-body">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="carrier" role="tabpanel" aria-labelledby="home-tab">
                        <br>
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div>
                                    <input class="form-control" placeholder="Address *" value="<?php echo $address; ?>"
                                        id="carrierAddressEdit" name="carrierAddress" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <div>
                                    <input class="form-control" placeholder="Zip Code" type="text"
                                        value="<?php echo $zip; ?>" id="carrierZipEdit" name="carrierZip">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                ...
                                <div>
                                    <input class="form-control" placeholder="Contact Name" type="text"
                                        value="<?php echo $contactName; ?>" id="carrierContactNameEdit"
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div>
                                    <input class="form-control" type="email" value="<?php echo $email; ?>"
                                        id="carrierEmailEdit" placeholder="Email" name="carrierEmail">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                ...
                                <div>
                                    <input class="form-control" type="text" value="<?php echo $telephone; ?>"
                                        id="carrierTelephoneEdit" name="carrierTelephone" placeholder="Telephone">
                                </div>
                            </div>
                            <div class="form-group col-md-1">
                                <label>Ext</label>
                                <div>
                                    <input class="form-control" placeholder="Ext" type="text"
                                        value="<?php echo $ext; ?>" id="carrierExtEdit" name="carrierExt">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                ...
                                <div>
                                    <input class="form-control" placeholder="Toll Free" type="text"
                                        value="<?php echo $tollfree; ?>" id="carrierTollFreeEdit"
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <div>
                                    <input class="form-control" placeholder="Fax" type="text"
                                        value="<?php echo $fax; ?>" id="carrierFaxEdit" name="carrierFax">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <div>
                                    <input class="form-control" placeholder="Tax ID *" type="text"
                                        value="<?php echo $taxID; ?>" id="carrierTaxIDEdit" name="carrierTaxID">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                <label>M.C. #: <span style="color: red">*</span></label>
                                <div>
                                    <input class="form-control" placeholder="M.C. #: *" type="text"
                                        value="<?php echo $mc; ?>" id="carrierMCEdit" name="carrierMC">
                                </div>
                            </div>
                            <div class="form-group col-md-2">
                                <label>D.O.T. <span style="color: red">*</span></label>
                                <div>
                                    <input class="form-control" placeholder="D.O.T. *" type="text"
                                        value="<?php echo $dot; ?>" id="carrierDOTEdit" name="carrierDOT">
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <input list="browsers1" class="form-control" value="<?php echo $factoringCompany; ?>"
                                    id="carrierFactoringEdit" name="carrierFactoring">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <div>
                                    <textarea rows="1" cols="30" class="form-control" type="textarea"
                                        value="<?php echo $carrierNotes; ?>" id="carrierNotesEdit"
                                        name="carrierNotes"></textarea>
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Liablity Company" type="text"
                                                    value="<?php echo $insuranceLiabilityCompany; ?>"
                                        ...
                                        <div class="form-group col-md-2">
                                            <label>Policy #</label>
                                            <div>
                                                <input class="form-control" placeholder="Policy #" type="text"
                                                    value="<?php echo $insurancePolicyNo; ?>" id="liabilityPolicyEdit"
                                                    name="liabilityPolicy">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" type="date"
                                                    value="<?php echo $expiryDate; ?>" id="liabilityExpDateEdit"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Telephone *" type="text"
                                                    ...
                                                    id="liabilityTelephoneEdit" name="liabilityTelephone">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-1">
                                            <label>Ext</label>
                                            <div>
                                                <input class="form-control" placeholder="Ext" type="text"
                                                    value="<?php echo $insuranceExt; ?>" id="liabilityEXTEdit"
                                                    name="liabilityEXT">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Contact Name" type="text"
                                                    value="<?php echo $insuranceContactName; ?>"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Liability ($)" type="text"
                                                    value="<?php echo $insuranceLiabilityAmount; ?>"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="customCheck9"
                                                data-parsley-multiple="groups" data-parsley-mincheck="2"
                                                onclick="setMobileInsurer1(this.value)">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Policy #" type="text"
                                                    value="<?php echo $autoInsPolicyNo; ?>" id="insurancePolicyEdit"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" type="date"
                                                    value="<?php echo $autoInsExpiryDate; ?>" id="insuranceExpDateEdit"
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Telephone *" type="text"
                                                    value="<?php echo $autoInsTelephone; ?>" id="insuranceTelephoneEdit"
                                        ...
                                        <div class="form-group col-md-1">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Ext" type="text"
                                                    value="<?php echo $autoInsExt; ?>" id="insuranceExtEdit"
                                                    name="insuranceExt">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Contact Name" type="text"
                                                    value="<?php echo $autoInsContactName; ?>"
                                                    id="insuranceContactNameEdit" name="insuranceContactName">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Liability ($)</label>
                                            <div>
                                                <input class="form-control" placeholder="Liability ($)" type="text"
                                                    value="<?php echo $autoInsLiabilityAmount; ?>" id="insuranceAmtEdit"
                                                    name="insuranceAmt">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            ...
                                            <div>
                                                <textarea rows="1" cols="30" class="form-control" type="textarea"
                                                    value="<?php echo $autoInsuranceNotes; ?>" id="insuranceNotesEdit"
                                                    name="insuranceNotes">
																		</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-3">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Cargo Company" type="text"
                                                    value="<?php echo $cargoCompany; ?>" id="cargoNameEdit"
                                                    name="cargoName">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Policy #" type="text"
                                                    value="<?php echo $cargoPolicyNo; ?>" id="cargoPolicyEdit"
                                                    name="cargoPolicy">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" type="date"
                                                    value="<?php echo $cargoExpiryDate; ?>" id="cargoExpDateEdit"
                                                    name="cargoExpDate">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                        ...
                                        <div class="form-group col-md-1">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Ext" type="text"
                                                    value="<?php echo $cargoExt; ?>" id="cargoExtEdit" name="cargoExt">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Contact Name</label>
                                            <div>
                                                <input class="form-control" placeholder="Contact Name" type="text"
                                                    value="<?php echo $cargoContactName; ?>" id="cargoContactNameEdit"
                                                    name="cargoContactName">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            ...
                                            <div>
                                                <input class="form-control" placeholder="Cargo Insurance ($)"
                                                    ...
                                                    id="cargoInsuranceAmountEdit" name="cargoInsuranceAmount">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>Internal Notes</label>
                                            <div>
                                                <textarea rows="1" cols="30" class="form-control" type="textarea"
                                                    value="<?php echo $cargoNotes; ?>" id="cargoNotesEdit"
                                                    name="cargoNotes"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>WSIB # </label>
                                            <div>
                                                <input class="form-control" placeholder="WSIB # " type="text"
                                                    value="<?php echo $WSIBNo; ?>" id="wsibEdit" name="wsib">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="accounting" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input class="form-control" placeholder="Primary Name" type="text"
                                        value="<?php echo $primaryName; ?>" id="primaryNameEdit" name="primaryName">
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <label>Primary Telephone</label>
                                <div>
                                    <input class="form-control" placeholder="Primary Telephone" type="text"
                                        value="<?php echo $primaryTelephone; ?>" id="primaryTelephoneEdit"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input class="form-control" type="email" value="bootstrap@example.com"
                                        value="<?php echo $primaryEmail; ?>" id="primaryEmailEdit" name="primaryEmail">
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <label>Secondary Name </label>
                                <div>
                                    <input class="form-control" placeholder="Secondary Name " type="text"
                                        value="<?php echo $secondaryName; ?>" id="secondaryNameEdit"
                                        name="secondaryName">
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    <input class="form-control" placeholder="Secondary  Telephone" type="text"
                                        value="<?php echo $secondaryTelephone; ?>" id="secondaryTelephoneEdit"
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div>
                                    <textarea rows="3" cols="30" class="form-control" type="textarea"
                                        value="<?php echo $accountingNotes; ?>" id="primaryNotesEdit"
                                        name="primaryNotes"></textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
                    ...
                    <div class="tab-pane fade" id="equipment" role="tabpanel" aria-labelledby="Equipment-tab">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input class="form-control" type="text" placeholder="Size Of Fleet :"
                                        value="<?php echo $sizeOfFleet; ?>" id="sizeOfFleetEdit" name="sizeOfFleet">
                                </div>
                            </div>
                        </center>
                        <?php
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <input class="form-control" type="text" value="<?php echo $amount; ?>"
                                        name="quantity">
                                </div>
                            </div>
                            <div class="form-group col-md-6">
