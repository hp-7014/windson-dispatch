        ...
        <div class="modal-dialog modal-xxl modal-dialog-scrollable">
            <div class="modal-content custom-modal-content">
                ...
                <div class="modal-body custom-modal-body" style="padding: 0.1rem">
                    <input class="form-control col-md-2 col-sm-4 col-lg-2 float-right"type="text" id="search" onkeyup="search_truck(this)" placeholder="search" style="margin-left: 5px;">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="custom-text" id="<?php echo "truckNumber".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "truckNumberPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $truckNumber; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'truckNumber','Truck Number',<?php echo $pencilid1; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "licensePlate".$i; ?>"
                                                    ...
                                                    <i id="<?php echo "licensePlatePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $licensePlate; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'licensePlate','License Plate',<?php echo $pencilid2; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "plateExpiry".$i; ?>"
                                                    ...
                                                    <i id="<?php echo "plateExpiryPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $plateExpiry; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'plateExpiry','Plate Expiry',<?php echo $pencilid3; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "inspectionExpiry".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "inspectionExpiryPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $inspectionExpiry; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'inspectionExpiry','Inspection Expiration',<?php echo $pencilid4; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "status".$i; ?>"
                                                    ...
                                                    <i id="<?php echo "statusPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $status; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'status','Status',<?php echo $pencilid5; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "ownership".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "ownershipPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $ownership; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'ownership','Ownership',<?php echo $pencilid6; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "mileage".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "mileagePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $mileage; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'mileage','Mileage',<?php echo $pencilid7; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "axies".$i; ?>"
                                                    ...
                                                    <i id="<?php echo "axiesPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $axies; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'axies','Axies',<?php echo $pencilid8; ?>)"
                                                    ></i>
                                                    <?php echo $row1['axies']; ?>
                                                </td>
                                                <td class="custom-text" id="<?php echo "year".$i; ?>"
                                                    ...
                                                    <i id="<?php echo "yearPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $year; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'year','Year',<?php echo $pencilid9; ?>)"
                                                    ></i>
                                                    <?php echo $row1['year']; ?>
                                                </td>
                                                <td class="custom-text" id="<?php echo "fuelType".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "fuelTypePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $fuelType; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'fuelType','Fuel Type',<?php echo $pencilid10; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "startDate".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "startDatePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $startDate; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'startDate','Start Date',<?php echo $pencilid11; ?>)"
                                                    ></i>
                                                    <?php echo $startDate; ?>
                                                </td>
                                                <td class="custom-text" id="<?php echo "deactivationDate".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "deactivationDatePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $deactivationDate; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'deactivationDate','Deactivation Date',<?php echo $pencilid12; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "ifta".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "iftaPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $ifta; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'ifta','IFTA Truck',<?php echo $pencilid13; ?>)"
                                                    ></i>
                                                    <?php echo $row1['ifta']; ?>
                                                </td>
                                                <td class="custom-text" id="<?php echo "registeredState".$i; ?>"
                                                    ...
                                                    <i id="<?php echo "registeredStatePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $registeredState; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'registeredState','Registered State',<?php echo $pencilid14; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "insurancePolicy".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "insurancePolicyPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $insurancePolicy; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'insurancePolicy','Insurance Policy',<?php echo $pencilid15; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "grossWeight".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "grossWeightPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $grossWeight; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'grossWeight','Empty / Gross Weight',<?php echo $pencilid16; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "vin".$i; ?>"
                                                    ...
                                                    <i id="<?php echo "vinPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $vin; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'vin','VIN',<?php echo $pencilid17; ?>)"
                                                    ></i>
                                                    <?php echo $row1['vin']; ?>
                                                </td>
                                                <td class="custom-text" id="<?php echo "dotexpiryDate".$i; ?>"
                                                    ...
                                                    >
                                                    <i id="<?php echo "dotexpiryDatePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $dotexpiryDate; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'dotexpiryDate','DOT Expiry Date',<?php echo $pencilid18; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "transponder".$i; ?>"
                                                    ...
                                                    <i id="<?php echo "transponderPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $transponder; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'transponder','Transponder',<?php echo $pencilid19; ?>)"
                                                    ></i>
                                                ...
                                                <td class="custom-text" id="<?php echo "internalNotes".$i; ?>"
                                                    ...
                                                    <i id="<?php echo "internalNotesPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                                        onclick="updateTableColumn(<?php echo $internalNotes; ?>,'updateTruckAdd','text',<?php echo $row1['_id']; ?>,'internalNotes','Internal Notes',<?php echo $pencilid20; ?>)"
                                                    ></i>
                                                    <?php echo $row1['internalNotes']; ?>
                                                </td>
                                                <td>
                                                    <?php if ($counter == 0) { ?>
                                                        <a href="#" onclick="deleteTruckAdd(<?php echo $id; ?>,<?php echo $truckid; ?>)"><i class="mdi mdi-delete-sweep-outline" style="font-size: 20px; color: #FC3B3B"></a></i>
                                                    <?php } else { ?>
                                ...
                                for ($i = 0; $i < $total_pages; $i++) {
                                    if ($i == 0) {
                                        ...
                                        <li class="pageitem active"
                                            onclick="paginate_trucks(<?php echo $i * $limit; ?>,<?php echo $limit ?>)"
