            ...
            <div class="modal-body custom-modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div>
                            <input class="form-control" placeholder="Address *" type="text" id="shipperAddress">
                        </div>
                    </div>
                    <div class="form-group col-md-2">
                        <label>Location <span style="color: red">*</span></label>
                        <div>
                            <input class="form-control" onkeydown="getLocation('shipperLocation')"
                                placeholder="Location *" type="text" id="shipperLocation">
                        </div>
                    </div>
                    <div class="form-group col-md-2">
                        <label>Postal / Zip <span style="color: red">*</span></label>
                        <div>
                            <input class="form-control" placeholder="Postal / Zip *" type="text" id="shipperPostal">
                        </div>
                    </div>
                    <div class="form-group col-md-2">
                        <label>Contact Name</label>
                        <div>
                            <input class="form-control" placeholder="Contact Name" type="text" id="shipperContact">
                        </div>
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div>
                            <input class="form-control" placeholder="Toll Free" type="text" id="shipperTollFree">
                        </div>
                    </div>
                    <div class="form-group col-md-3">
                        <label>Fax</label>
                        <div>
                            <input class="form-control" placeholder="Fax" type="text" id="shipperFax">
                        </div>
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="customCheck1"
                                name="shipperASconsignee" data-parsley-multiple="groups" data-parsley-mincheck="2">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <div>
                            <textarea rows="3" cols="30" placeholder="Shipping Notes" class="form-control"
                                type="textarea" id="shippingNotes"></textarea>
                        </div>
                    </div>
                    <div class="form-group col-md-5">
