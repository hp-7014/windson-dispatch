                                    ...
                                    foreach ($show as $s) {
                                        ...
                                        if ($s['deleteStatus'] == '0') {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" id="driverLicenseIssue<?php echo $s['_id']; ?>1"
                                                       data-type="textarea"
                                                ...
                                                <td>
                                                    <a href="#" id="driverLastDrugTest<?php echo $s['_id']; ?>1"
                                                       data-type="textarea"
                                                ...
                                                <td>
                                                    <a href="#" id="driverNextDrugTest<?php echo $s['_id']; ?>1"
                                                       data-type="textarea"
