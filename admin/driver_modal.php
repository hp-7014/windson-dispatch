        ...
        <div class="modal-content custom-modal-content">
            ...
            <div class="modal-body custom-modal-body" style="padding: 0.1rem">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <input class="form-control col-md-2 col-sm-4 col-lg-2 float-right" type="text" onkeyup="search_driver(this)"
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="custom-text" id="<?php echo "driverName".$i; ?>"
                                                ...
                                                >
                                                <i id="<?php echo "driverNamePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                            ...
                                            <td class="custom-text" id="<?php echo "driverEmail".$i; ?>"
                                                ...
                                                >
                                                <i id="<?php echo "driverEmailPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                            ...
                                            <td class="custom-text" id="<?php echo "driverLocation".$i; ?>"
                                                ...
                                                >
                                                <i id="<?php echo "driverLocationPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                            ...
                                            <td class="custom-text" id="<?php echo "driverSocial".$i; ?>"
                                                ...
                                                >
                                                <i id="<?php echo "driverSocialPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                            ...
                                            <td class="custom-text" id="<?php echo "dateOfbirth".$i; ?>"
                                                ...
                                                >
                                                <i id="<?php echo "dateOfbirthPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                            ...
                                            <td class="custom-text" id="<?php echo "dateOfhire".$i; ?>"
                                                ...
                                                >
                                                <i id="<?php echo "dateOfhirePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                            ...
                                            <td class="custom-text" id="<?php echo "driverLicenseNo".$i; ?>"
                                                ...
                                                >
                                                <i id="<?php echo "driverLicenseNoPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                            ...
                                            <td class="custom-text" id="<?php echo "driverLicenseIssue".$i; ?>"
                                                ...
                                                >
                                                <i id="<?php echo "driverLicenseIssuePencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                            ...
                                            <td class="custom-text" id="<?php echo "driverLicenseExp".$i; ?>"
                                                ...
                                                >
                                                <i id="<?php echo "driverLicenseExpPencil".$i; ?>" class="mdi mdi-lead-pencil edit-pencil"
                                            ...
                                            <td>
                                                <a href="#" onclick="deleteDriver(<?php echo $s['_id']; ?>,<?php echo $currency; ?>)"><i class="mdi mdi-delete-sweep-outline" style="font-size: 20px; color: #FC3B3B"></i></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
