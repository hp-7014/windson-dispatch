            ...
            <div class="modal-body custom-modal-body">
                <div class="container">
                    <table class=" table-responsive">
                        ...
                        <td width="200"><input name=" " type="text" value=" " class="form-control"/></td>
                        <td width="150"><input name=" " type="text" value=" " class="form-control"/></td>
                        <td>
...
<script>
    ...
    function GetDynamicTextBox(value) {
        return '<td width="200"><input name = "DynamicTextBox" type="text" value = "' + value + '" class="form-control" /></td>' + '<td width="150"><input name = "DynamicTextBox" type="text" value = "' + value + '"class="form-control" /></td>' + '<td><button type="button" class="btn btn-danger remove"><span aria-hidden="true">&times;</span></button></td>'
    }
</script>
