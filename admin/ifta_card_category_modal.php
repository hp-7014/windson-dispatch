            ...
            <div class="modal-body custom-modal-body" style="padding: 0.1rem">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <button type="button" class="btn btn-outline-info waves-effect waves-light float-right"
                        onclick="importCard_Cat()">Upload</button>
                            ...
                            <table id="tech-companies-1" class="scroll">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" col width="100">Card Type</th>
                                        <th scope="col" col width="70">Action</th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td class="custom-text" id="<?php echo "cardHolderName".$i; ?>"
                                            ...
                                            <i id="<?php echo "cardHolderNamePencil".$i; ?>"
                                                ...
                                                onclick="updateTableColumn(<?php echo $cardHolderName; ?>,'updateCardCat','text',<?php echo $ifta['_id']; ?>,'cardHolderName','Card Holder Name',<?php echo $pencilid1; ?>)"></i>
                                        ...
                                        <td class="custom-text" id="<?php echo "iftaCardNo".$i; ?>"
                                            ...
                                            <i id="<?php echo "iftaCardNoPencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $iftaCardNo; ?>,'updateCardCat','text',<?php echo $ifta['_id']; ?>,'iftaCardNo','IFTA Card No.',<?php echo $pencilid2; ?>)"></i>
                                        ...
                                        <td class="custom-text" id="<?php echo "cardType".$i; ?>"
                                            ...
                                            <i id="<?php echo "cardTypePencil".$i; ?>"
                                                class="mdi mdi-lead-pencil edit-pencil"
                                                onclick="updateTableColumn(<?php echo $cardType; ?>,'updateCardCat','text',<?php echo $ifta['_id']; ?>,'cardType','Card Type',<?php echo $pencilid3; ?>)"></i>
                                            <?php echo $ifta['cardType']; ?>
                                        </td>
                                        <td>
                                            <?php if ($counter == 0) { ?>
                                            <a href="#" onclick="deleteCardCat(<?php echo $ifta['_id']; ?>)"><i
