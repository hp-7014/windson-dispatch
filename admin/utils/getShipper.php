    ...
    foreach ($show1 as $row1) {
        ...
        echo "
            <tr>
                ...
                <td>
                    <a href='#' id='shipperAddress".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperAddressColmn)' class='text-overflow'>$shipperAddress</a>
                ...
                <td>
                    <a href='#' id='shipperLocation".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperLocationColmn)' class='text-overflow'>$shipperLocation</a>
                ...
                <td>
                    <a href='#' id='shipperPostal".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperPostalColmn)' class='text-overflow'>$shipperPostal</a>
                ...
                <td>
                    <a href='#' id='shipperContact".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperContactColmn)' class='text-overflow'>$shipperContact</a>
                ...
                <td>
                    <a href='#' id='shipperEmail".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperEmailColmn)' class='text-overflow'>$shipperEmail</a>
                ...
                <td>
                    <a href='#' id='shipperTelephone".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperTelephoneColmn)' class='text-overflow'>$shipperTelephone</a>
                ...
                <td>
                    <a href='#' id='shipperExt".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperExtColmn)' class='text-overflow'>$shipperExt</a>
                ...
                <td>
                    <a href='#' id='shipperTollFree".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperTollFreeColmn)' class='text-overflow'>$shipperTollFree</a>
                ...
                <td>
                    <a href='#' id='shipperFax".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperFaxColmn)' class='text-overflow'>$shipperFax</a>
                ...
                <td>
                    <a href='#' id='shipperShippingHours".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperShippingHoursColmn)' class='text-overflow'>$shipperShippingHours</a>
                ...
                <td>
                    <a href='#' id='shipperAppointments".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperAppointmentsColmn)' class='text-overflow'>$shipperAppointments</a>
                ...
                <td>
                    <a href='#' id='shipperIntersaction".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperIntersactionColmn)' class='text-overflow'>$shipperIntersaction</a>
                ...
                <td>
                    <a href='#' id='shipperStatus".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shipperStatusColmn)' class='text-overflow'>$shipperStatus</a>
                ...
                <td>
                    <a href='#' id='shippingNotes".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$shippingNotesColmn)' class='text-overflow'>$shippingNotes</a>
                ...
                <td>
                    <a href='#' id='internalNotes".$id."1' data-type='textarea' onclick='showTextarea(this.id,$type,$id,$internalNotesColmn)' class='text-overflow'>$internalNotes</a>
