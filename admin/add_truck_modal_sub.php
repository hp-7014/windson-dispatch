                ...
                <form method="post" enctype="multipart/form-data" id="truckform">
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div>
                                <input class="form-control" placeholder="Truck Number *" type="text" id="truck_number"
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div class="row">
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="ownership" name="ownershipp"
                                        value="Company Truck">
                                    <label class="custom-control-label" for="ownership">Company Truck</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="Own" name="ownershipp"
                        ...
                        <div class="form-group col-md-2">
                            <label>Mileage</label>
                            <div>
                                <input class="form-control" placeholder="Mileage" type="text" id="mileage"
                                    name="mileage">
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="customCheck1"
                                    name="customCheck1" data-parsley-multiple="groups" data-parsley-mincheck="2"
                                    value="IFTA Truck">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div>
                                <textarea rows="2" cols="30" class="form-control" type="textarea" id="Internal_note"
                                    placeholder="Internal Note" name="Internal_note"></textarea>
