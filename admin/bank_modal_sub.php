            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input class="form-control" placeholder="Name of Bank: *" type="text" name="bankName"
                                id="bankName">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input class="form-control" placeholder="Address / Branch " type="text" name="bankAddress"
                                id="bankAddress">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label>Account Holder Name <span class="mandatory">*</span></label> <i
                            class="mdi mdi-plus-circle plus" title="Add Company" id="AddCompany"></i>
                        <div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input class="form-control" placeholder="Bank Account *" type="text" name="accountNo"
                                id="accountNo">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input class="form-control" placeholder="Bank Routing: *" type="text" name="routingNo"
                                id="routingNo">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input class="form-control" placeholder="Current Cheque no " type="text"
                                name="currentcheqNo" id="currentcheqNo">
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="AddBankAdmin()" class="btn btn-primary waves-effect waves-light">Save
