    ...
    <div class="modal-dialog modal-xxl modal-dialog-scrollable">
        <div class="modal-content custom-modal-content">
            ...
            <div class="modal-body custom-modal-body" style="padding: 0.1rem">
                ...
                <button class="btn btn-primary float-left" type="button" data-toggle="modal" data-target="#add_sub_credit"><i class="mdi mdi-gamepad-down"></i>&nbsp;ADD</button>
                                ...
                                foreach ($sub_credit as $admin) {
                                        ...
                                        if ($admin['delete_status'] == '0') {
                                            ...
                                            <tr>
                                                <th><?php echo $i++ ?></th>
                                                <td>
                                                    <a href="#" id="displayName<?php echo $admin['_id']; ?>1" data-type="textarea" onclick="showTextarea(this.id,'text',<?php echo $admin['_id']; ?>,'displayName');" class="text-overflow"><?php echo $admin['displayName']; ?></a>
                                                    <button type="button" id="displayName<?php echo $admin['_id']; ?>" onclick="updateSubCredit('displayName',<?php echo $admin['_id']; ?>)" style="display:none; margin-left:6px;" class="btn btn-success editable-submit btn-sm waves-effect waves-light text-center"><i class="mdi mdi-check"></i></button>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <a href="#" id="cardHolderName<?php echo $admin['_id']; ?>2" data-type="textarea" onclick="showTextarea(this.id,'text',<?php echo $admin['_id']; ?>,'cardHolderName');" class="text-overflow"><?php echo $admin['cardHolderName']; ?></a>
                                                    <button type="button" id="cardHolderName<?php echo $admin['_id']; ?>" onclick="updateSubCredit('cardHolderName',<?php echo $admin['_id']; ?>)" style="display:none; margin-left:6px;" class="btn btn-success editable-submit btn-sm waves-effect waves-light text-center"><i class="mdi mdi-check"></i></button>
                                                </td>
                                                <td>
                                                    <a href="#" id="cardNo<?php echo $admin['_id']; ?>3" data-type="textarea" onclick="showTextarea(this.id,'text',<?php echo $admin['_id']; ?>,'cardNo');" class="text-overflow"><?php echo $admin['cardNo']; ?></a>
                                                    <button type="button" id="cardNo<?php echo $admin['_id']; ?>" onclick="updateSubCredit('cardNo',<?php echo $admin['_id']; ?>)" style="display:none; margin-left:6px;" class="btn btn-success editable-submit btn-sm waves-effect waves-light text-center"><i class="mdi mdi-check"></i></button>
                                                </td>
                                                <td><a href="#" onclick="deleteSubCredit(<?php echo $admin['_id']; ?>)"><i class="mdi mdi-delete-sweep-outline" style="font-size: 20px; color: #FC3B3B"></i></a>
                                                </td>
                                            </tr>
                                        <?php }
                                    }
