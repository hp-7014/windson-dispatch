    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label>Name of Bank: <span class="mandatory">*</span></label><i title="Add Bank" class="mdi mdi-plus-circle plus" id="AddBank"></i>
                        <div>
            ...
            <div class="modal-footer">
                <label class="text-danger" style="padding-right: 152px"><b>Note :</b>&nbsp; * Fields are mandatory</label>
