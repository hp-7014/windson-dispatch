...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" id="addRecurrenceEdit"
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content custom-modal-content">
            ...
            <div class="modal-header custom-modal-header">
                ...
                <button type="button" class="close modalrecurrenceaddEdit" aria-label="Close">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger waves-effect modalrecurrenceaddEdit">
                    Close
                </button>
                <button type="button" class="btn btn-primary waves-effect waves-light" onclick="getrecurrenceEdit()">Save
                </button>
            </div>
