            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input class="form-control" placeholder="Broker Name *" type="text" name="brokerName"
                                id="brokerName">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input class="form-control" placeholder="Crossing *" type="text" name="crossing"
                                id="crossing">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <div>
                            <input class="form-control" placeholder="Telephone No" type="text" name="telephone"
                                id="telephone">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div>
                            <input class="form-control" placeholder="Toll Free" type="text" name="tollfree"
                                id="tollfree">
                        </div>
                    </div>
                    <div class="form-group col-md-6">
