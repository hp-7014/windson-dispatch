                                        ...
                                        <tr>
                                            ...
                                            >
                                                <i id="<?php echo "custNamePencil" . $i; ?>"
                                                   ...
                                                   onclick="updateTableColumn(<?php echo $custName; ?>,'updateCustomer','text',<?php echo $mainID; ?>,'custName','Customer Name',<?php echo $pencilid1; ?>)"
                                                ></i>
                                                <?php echo $s['custName']; ?>
                                            </td>
                                            ...
                                            >
                                                <i id="<?php echo "custLocationPencil" . $i; ?>"
                                                   class="mdi mdi-lead-pencil edit-pencil"
                                                   onclick="updateTableColumn(<?php echo $custLocation; ?>,'updateCustomer','text',<?php echo $mainID; ?>,'custLocation','Location',<?php echo $pencilid2; ?>)"
                                                ></i>
                                            ...
                                            >
                                                <i id="<?php echo "custZipPencil" . $i; ?>"
                                                   class="mdi mdi-lead-pencil edit-pencil"
                                                   onclick="updateTableColumn(<?php echo $custZip; ?>,'updateCustomer','text',<?php echo $mainID; ?>,'custZip','Zip',<?php echo $pencilid3; ?>)"
                                                ></i>
                                                <?php echo $s['custZip']; ?>
                                            </td>
                                            ...
                                            >
                                                <i id="<?php echo "primaryContactPencil" . $i; ?>"
                                                   class="mdi mdi-lead-pencil edit-pencil"
                                                   onclick="updateTableColumn(<?php echo $primaryContact; ?>,'updateCustomer','text',<?php echo $mainID; ?>,'primaryContact','Primary Contact',<?php echo $pencilid4; ?>)"
                                                ></i>
                                            ...
                                            >
                                                <i id="<?php echo "custTelephonePencil" . $i; ?>"
                                                   class="mdi mdi-lead-pencil edit-pencil"
                                                   onclick="updateTableColumn(<?php echo $custTelephone; ?>,'updateCustomer','text',<?php echo $mainID; ?>,'custTelephone','Telephone',<?php echo $pencilid5; ?>)"
                                                ></i>
                                            ...
                                            >
                                                <i id="<?php echo "custEmailPencil" . $i; ?>"
                                                   class="mdi mdi-lead-pencil edit-pencil"
                                                   onclick="updateTableColumn(<?php echo $custEmail; ?>,'updateCustomer','text',<?php echo $mainID; ?>,'custEmail','Email',<?php echo $pencilid6; ?>)"
                                                ></i>
                                            ...
                                            <td>
                                                <?php if ($counter == 0) { ?>
                                                    <a href="#"
                                                       onclick="deleteCustomer(<?php echo $mainID; ?>,<?php echo $currencyid; ?>,<?php echo $paymentid; ?>,<?php echo $factoringid; ?>)"><i
