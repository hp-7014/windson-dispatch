...
// Add Master FUEL CARD TYPE
$(document).on('click', '#add_fuel_card', function() {

    $.ajax({
        type: 'POST',
        success: function(data) {
            $('.modal-container').load('./master/add_fuel_card_modal.php', function(result) {
                $('#fuel_card').modal({ show: true });
            });
        }
    });
});

$(document).on('click', '#addfuelCard', function() {
    $.ajax({
        type: 'POST',
        success: function(data) {
            $('.fuel-card-container').load('./master/add_fuel_card_sub.php', function(result) {
                $('#fuelcardsub').modal({ show: true });
            });
        }
    });
});

$(document).on('click', '.modalFuel_Card', function() {
...
$(document).on('click', '#AddConsignee', function() {
    $.ajax({
        type: 'POST',
        success: function(data) {
            $('.consigne-container').load('./admin/consignee_modal_sub.php', function(result) {
                $('#add_consignee').modal({ show: true });
            });
        }
    });
});
// stop window to scroll
...
$(document).on('click', '#Add_Ifta_Card', function() {
    $.ajax({
        type: 'POST',
        success: function(data) {
            $('.iftacard-category-container').load('./admin/iftacard_modal_sub.php', function(result) {
...
$(document).on("click", "#add_ifta_card", function() {
    $.ajax({
        type: 'POST',
        success: function(data) {
            $('.modal-container').load('./admin/ifta_card_category_modal.php', function(result) {
